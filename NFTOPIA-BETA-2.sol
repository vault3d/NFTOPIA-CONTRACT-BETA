...
contract NFTBABY is IBEP20, Ownable {
    ...
    // wallet for buybacks
    address public constant buybackWallet = 0x3308f174810FD9b158bFE6DF81115752c44c6457; // Change to NFTopia admin wallet address

    // wallet for marketing
    address payable public marketingWallet = payable(0xB56b30bb189de3A7CE61178e2754EA59Ca6078C4); // Change to NFTopia marketing wallet
